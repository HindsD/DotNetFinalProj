...
{
    public partial class Northwind_88_DWHContext : DbContext
    {

        public Northwind_88_DWHContext()
        {
            
        }

        public Northwind_88_DWHContext(DbContextOptions<Northwind_88_DWHContext> options)
            : base(options)
        {
        }
